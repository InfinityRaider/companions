...
import com.InfinityRaider.companions.renderers.particles.DustFX;
...
public class PlayerEffectRendererNavi extends PlayerEffectRenderer {
    ...
    protected PlayerEffectRendererNavi() {
        ...
        largeWing = new ResourceLocation(Reference.MOD_ID, "textures/entities/player/navi/wingLarge.png");
        smallWing = new ResourceLocation(Reference.MOD_ID, "textures/entities/player/navi/wingSmall.png");
        texture = new ResourceLocation(Reference.MOD_ID, "textures/entities/player/navi/navi.png");
