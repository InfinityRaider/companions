...
public class PlayerEffectRendererButterfly extends PlayerEffectRenderer {
    ...
    protected PlayerEffectRendererButterfly() {
        super();
        texture = new ResourceLocation(Reference.MOD_ID, "textures/entities/player/butterfly/butterfly.png");
        sparkle = new ResourceLocation(Reference.MOD_ID, "textures/entities/player/butterfly/sparkle.png");
    }
