...
import com.InfinityRaider.companions.renderers.particles.RuneFX;
...
public class PlayerEffectRendererParticlesEnchanted extends PlayerEffectRendererParticles {
    ...
    protected ResourceLocation getParticleTexture() {
        return new ResourceLocation(Reference.MOD_ID, "textures/entities/player/particles/runes.png");
    }
